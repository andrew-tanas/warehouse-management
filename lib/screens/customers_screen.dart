...
class _CustomersScreenState extends State<CustomersScreen> {
  ...
  void _showAddEditDialog(BuildContext context, [Customer? customer]) {
    ...
    final debtController = TextEditingController(text: customer?.totalDebt.toString() ?? '0.0');
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              title: Text(
                customer == null ? AppLocalizations.of(context).translate('add_customer') : AppLocalizations.of(context).translate('edit'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      value: genre,
                      decoration: InputDecoration(
                        labelText: AppLocalizations.of(context).translate('genre'),
                        border: const OutlineInputBorder(),
                      ),
                      items: [
                        DropdownMenuItem(value: 'wholesaler', child: Text(AppLocalizations.of(context).translate('wholesaler'))),
                        DropdownMenuItem(value: 'retail trader', child: Text(AppLocalizations.of(context).translate('retail'))),
                        DropdownMenuItem(value: 'normal', child: Text(AppLocalizations.of(context).translate('normal'))),
                      ],
                      onChanged: (val) {
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: AppLocalizations.of(context).translate('total_debt'),
                        border: const OutlineInputBorder(),
                      ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                if (amount > 0) {
                  Provider.of<CustomerProvider>(context, listen: false).addPayment(customer.id!, amount, noteController.text.trim(), selectedDate);
                  Navigator.pop(context);
                }
              },
    ...
    return AppNavigation(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text(AppLocalizations.of(context).translate('add_customer'), style: const TextStyle(color: Colors.white)),
        ),
        body: Padding(
              ...
              Expanded(
                child: Consumer<CustomerProvider>(
                  builder: (context, provider, child) {
                    ...
                    List<Customer> filteredCustomers = provider.customers.where((customer) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (customer.genre == 'wholesaler') localizedGenre = AppLocalizations.of(context).translate('wholesaler');
                        else if (customer.genre == 'normal') localizedGenre = AppLocalizations.of(context).translate('normal');
                        ...
                        return Card(
                          ...
                          child: InkWell(
                            ...
                            leading: CircleAvatar(
                              ...
                              child: const Icon(Icons.business_center, color: Color(0xFF6C63FF)),
                            ),
                            title: Text(
                              customer.name, 
                            ...
                            trailing: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(AppLocalizations.of(context).translate('total_debt'), style: const TextStyle(fontSize: 12, color: Colors.grey)),
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold, 
                                        fontSize: 16, 
                                        color: customer.totalDebt > 0 ? Colors.redAccent : Colors.green,
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                IconButton(
                                  ...
                                  onPressed: () => _showPayDialog(context, customer),
                                  tooltip: AppLocalizations.of(context).translate('pay'),
                                ),
                                IconButton(
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    if (customer.id != null) {
                                      _confirmDelete(context, provider, customer);
                                    }
                                  },
